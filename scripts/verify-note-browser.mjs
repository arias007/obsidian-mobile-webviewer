...
const checks = [
  ...
  ["explicit Obsidian open links route to NoteWeb", source.includes("parseObsidianOpenLink") && externalLinkMethod.includes("this.openNoteBrowser(rawHref, true)") && source.includes("renderObsidianNoteEmbed") && source.includes("MarkdownRenderer.renderMarkdown")],
