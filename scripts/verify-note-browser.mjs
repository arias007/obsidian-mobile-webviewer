...
const checks = [
  ...
  ["NoteWeb magic wand proxy never enters the guest page", source.includes("mwv-notedraw-host-proxy") && source.includes("this.noteDrawStableAnchorHost(surface)") && source.includes('this.setNoteBrowserEmbedMode(current, "note")') && !source.includes("executeJavaScript(\"document.body.appendChild")],
