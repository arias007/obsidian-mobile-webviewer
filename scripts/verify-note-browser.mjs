...
const checks = [
  ...
  ["NoteWeb keeps exactly one live surface and parks the rest up to the pool cap", source.includes("existing.slice(1)") && source.includes('querySelector<HTMLElement>(":scope > .mwv-live-frame")') && source.includes("mwv-parked-frame") && source.includes("MAX_LIVE_TAB_SURFACES") && source.includes("ownsEmbedSurfaceView")],
